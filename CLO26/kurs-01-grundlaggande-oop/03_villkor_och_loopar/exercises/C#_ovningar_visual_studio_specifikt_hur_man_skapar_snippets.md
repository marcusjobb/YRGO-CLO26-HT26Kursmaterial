...
status: adapted
marcus_voice: true
source: "Old_courses/Material från Codic/C#/Övningar/Visual Studio Specifikt/Hur man skapar Snippets.docx"
description: "I det här experimentet ska vi skapa ett par snippets"
tags: ["conditions", "csharp", "exercise", "hur", "man", "skapar", "snippets.docx", "sql"]
week_fit: []
---
Snippets
I det här experimentet ska vi skapa ett par snippets
En snippet är en shortcut i Visual Studio som generar kod till oss.
För detta öppnar vi kör funktionen i Windows (Windows knapp + R) eller den vanliga filutforskaren vi
väljer att öppna följande mapp
...
Innanför <![CDATA[ ]]> kan du skriva vilken kod du vill, dock är det vissa tecken som är specialhanterade
och måste skrivas på ett speciellt sätt. $ är något som får CDATA att krascha så skriv alltid $$ för att den
inte ska flippa ur.
...
<Snippet>
<Code Language="CSharp">
<![CDATA[optionsBuilder.UseSqlServer($$@"Server=.
...
Här skapar vi en variabel som vi kallar MyModel, den kan användas i vår kod som $MyModel$ och då
kommer VS att fråga oss om vilken model vi vill använda.
