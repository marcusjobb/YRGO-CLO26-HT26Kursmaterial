...
Logiska operatorer kombinerar flera booleska uttryck till ett.

### && (och)

`&&` är sant bara om **båda** sidor är sanna.
...
`!inloggad` är `!false` vilket är `true` — if-blocket körs.

---

## Short-circuit

C# utvärderar logiska uttryck med kortslutning (short-circuit). Det betyder att C# slutar utvärdera ett uttryck så fort resultatet är avgjort.
