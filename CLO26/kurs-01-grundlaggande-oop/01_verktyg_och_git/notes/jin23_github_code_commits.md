...
status: adapted
marcus_voice: true
source: "Old_courses/books/JIN23/github/code/commits.md"
description: "Denna action genererar en markdown-fil med statistik över hur många commits varje person har gjort, hur många rader de har lagt till och tagit bort samt vilken commit som var den senaste."
tags: ["commits", "contribution", "git", "java", "sql", "statistics"]
week_fit: []
---
