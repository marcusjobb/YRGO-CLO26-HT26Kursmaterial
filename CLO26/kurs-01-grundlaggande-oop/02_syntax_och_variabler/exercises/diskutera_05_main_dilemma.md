...
1. Vem bär ansvaret — Jenny eller Fredrik?
2. Spelar det roll att Fredrik sa "jag tar ansvaret"?
3. Borde Jenny ha vägrat? Vad hade hänt då?
4. Vad borde processen ha sett ut för att det här aldrig skulle hända?
5. Vad lär sig Jenny av det här — om kod, om arbetsplatser, om att säga nej?
...
>
> Bra system har skyddsmekanismer så att en person inte kan krascha production.
