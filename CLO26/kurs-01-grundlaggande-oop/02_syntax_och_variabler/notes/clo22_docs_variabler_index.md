...
status: adapted
marcus_voice: true
source: "Old_courses/books/CLO22/Docs/variabler/index.md"
description: "En variabel är en behållare som används för att lagra data. I C# måste alla variabler deklareras innan de kan användas. Detta innebär att du måste ange vilken typ av data som variabeln kommer att lagr"
tags: ["csharp", "git", "syntax", "variabler"]
week_fit: []
---
