...
status: adapted
marcus_voice: true
source: "Old_courses/books/csharp_cmyh/C-Sharp/begin_csharp/print-exempel.md"
description: "Det här kapitlet är din introduktion till att prata med datorn!  Vi ska lära oss hur man får C-Sharp att"
tags: ["csharp", "enkla", "exempel", "git", "oop", "print", "syntax", "utskrifter"]
week_fit: []
---
