...
status: adapted
marcus_voice: true
source: "Old_courses/books/CLO22/Docs/variabler/typer.md"
description: "En typ är en klassificering av data som används för att bestämma vilken typ av värde en variabel kan lagra. I C# finns det två typer av typer: värdestyper och referenstyper."
tags: ["csharp", "git", "oop", "syntax", "typer"]
week_fit: []
---
