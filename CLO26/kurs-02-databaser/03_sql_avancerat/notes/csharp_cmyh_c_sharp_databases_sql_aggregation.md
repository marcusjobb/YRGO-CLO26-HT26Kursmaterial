...
När du behöver räkna, summera eller beräkna medelvärden – då är aggregering rätt verktyg.
Med `GROUP BY` grupperar du data och med `HAVING` filtrerar du grupper.
...
| 2         | Bengt     | Larsson  | bengt@example.com |
| 3         | Cecilia   | Svensson | NULL              |
